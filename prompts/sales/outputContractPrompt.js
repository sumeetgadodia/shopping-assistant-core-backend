...
- needs_followup equals ask. ask=false → empty question/options/followup_reason. ask=true → one short question, followup_reason=dimension; binary adult/child has exactly 2 unique options, otherwise 3–5.
...
Self-check: all facts grounded; all facet names/values active except dynamic Price; merge duplicates; no unsupported stock/price/discount/delivery/fit claim; one question only in followup_question.
`;
