...
- Separate purchase target from styling anchor and retrieve only the target. Example: "women's jewellery to match an emerald saree" emits Women + jewellery-only target; emerald saree is guidance, never an apparel filter/result. Match/similar/ordinal/comparison requests require runtime product context; otherwise ask for the link/selection.
